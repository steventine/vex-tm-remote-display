...
"      var kbps = Math.round(data.frag.stats.bwEstimate / 1000);\n"
"      if (kbps > 0) {\n"
...
"        if (latency > 0) statLatency.textContent = 'Latency: ' + latency.toFixed(1) + 's';\n"
"      }\n"
"    }, 1000);\n"
...
"    statsDiv.classList.remove('visible'); statsDiv.classList.add('hidden');\n"
