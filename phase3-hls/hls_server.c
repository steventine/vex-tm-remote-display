...
"  <div class=\"stat-row\" id=\"stat-rate\">Speed: 1.0x</div>\n"
...
"    dot.style.background = currentLatency < 7 ? '#eab308' : '#f97316';\n"
"  }\n"
"}, 1000);\n"
"\n"
...
"        statRate.textContent = 'Speed: ' + video.playbackRate.toFixed(1) + 'x';\n"
"      }\n"
"    }, 1000);\n"
